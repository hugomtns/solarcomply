    ...
    return (
      <div className="flex justify-end gap-2">
        <div className="max-w-[70%]">
          <div className="rounded-2xl rounded-br-sm bg-[#2E75B6] px-4 py-2.5 text-sm text-white">
            {message.content}
          </div>
          <p className="mt-1 text-right text-[10px] text-gray-400">{time}</p>
        </div>
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#2E75B6]">
