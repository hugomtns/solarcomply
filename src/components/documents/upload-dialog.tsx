        ...
        <div className="flex items-center gap-1 px-1">
          {steps.map((step, i) => (
            <div key={step.key} className="flex flex-1 items-center gap-1">
              ...
              <span className={`text-[11px] ${i <= stepIndex ? "text-text-heading font-medium" : "text-text-muted"}`}>
                {step.label}
              </span>
              {i < steps.length - 1 && (
                <div className={`flex-1 h-px ${i < stepIndex ? "bg-brand-blue" : "bg-surface-glass-hover"}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="min-h-[200px]">
          ...
          {currentStep === "validation" && (
            <div className="flex flex-col items-center gap-4 py-6">
              {validating ? (
                <>
                  <div className="h-12 w-12 animate-spin rounded-full border-4 border-surface-glass-hover border-t-brand-blue" />
                  <p className="text-sm font-medium text-text-secondary">Validating document...</p>
          ...
          {currentStep === "preview" && (
            <div className="space-y-3">
              ...
              <div className="rounded-lg border bg-surface-glass p-3 space-y-2">
