  ...
  return (
    <aside className="fixed left-0 top-0 z-30 flex h-screen w-64 flex-col border-r border-white/[0.06] bg-[#070d1a]/95 backdrop-blur-xl text-white">
      ...
      <div className="flex items-center gap-3 px-5 py-5">
        <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#06D6A0] to-[#3B82F6] shadow-[0_0_20px_rgba(6,214,160,0.3)]">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-2">
        ...
        >
          ...
          Portfolio
          {pathname === "/portfolio" && (
            <span className="absolute left-0 h-8 w-1 rounded-r-full bg-[#06D6A0] shadow-[0_0_8px_rgba(6,214,160,0.5)]" />
          )}
        </Link>
                ...
                <div key={p.id}>
                  ...
                  {activeProjectId === p.id && (
                    <div className="ml-3 mt-1 space-y-0.5">
                      {/* Core section */}
                      <p className="px-2 pt-1 pb-0.5 text-[9px] font-semibold uppercase tracking-[0.15em] text-slate-600">
                        Core
                      </p>
                        ...
                        return (
                          <Link
                            ...
                            className={cn(
                              ...
                              isActive
                                ? "bg-[#06D6A0]/10 text-[#06D6A0] font-medium"
                                : "text-slate-500 hover:bg-white/[0.04] hover:text-slate-300"
                            )}
                          >
                      ...
                      {/* Enterprise section */}
                      <p className="px-2 pt-0.5 pb-0.5 text-[9px] font-semibold uppercase tracking-[0.15em] text-slate-600">
                        Enterprise
                      </p>
      ...
      <div className="border-t border-white/[0.06] px-4 py-4 bg-white/[0.02]">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[#06D6A0] to-[#3B82F6] text-sm font-semibold ring-2 ring-[#06D6A0]/20">
            {currentUser.avatar || "MS"}
          </div>
          <div className="min-w-0">
            <p className="truncate text-sm font-medium text-slate-200">{currentUser.name}</p>
            <p className="truncate text-xs text-slate-500">{userOrg?.name}</p>
          </div>
        </div>
      </div>
    </aside>
